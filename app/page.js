          ...
          <div className="grid grid-cols-4 gap-8">
            {statsData.map((item, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-2xl font-medium text-[rgba(107,114,128,0.8)] mb-2">
                  {item.label}
                </div>
              </div>
            ))}
            ...
            {featuresData.map((item, index) => (
              <Card key={index} className="p-6">
                <CardContent className=" space-y-1 pt-4">
                  ...
                  <p className="text-[rgba(107,114,128)] font-medium">
                    {" "}
                    {item.description}
                  </p>
                </CardContent>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl mb-4 font-bold text-center text-gray-800">
            {" "}
            Join Thousands of Happy Users Across the World!
          </h2>
          <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <CardContent>
                  <div className="flex items-center mb-3">
                    <Image
                      ...
                      width={60}
                      height={60}
                      className="rounded-lg border-1 border-gray-800 "
                    />
                    <div className="ml-4">
                  ...
                  <p className="text-gray-700 text-sm tracking-tighter font-mono font-light">
                    {" "}
                    {item.quote}{" "}
                  </p>
                </CardContent>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-400 to-purple-400 ">
        <div className="container mx-auto px-4 text-center">
          <p className="text-blue-100 mb-2 max-w-2xl mx-auto text-2xl ">
            ...
            is here to assist you smartly track your finances through the use of
            AI.
          </p>
          ...
          <Link href="/dashboard">
            <Button
              size="lg"
              className="bg-white text-blue-700 hover:bg-blue-50 animate-bounce border-2 border-blue-900"
            >
              Start Free Trial
            </Button>
          </Link>
